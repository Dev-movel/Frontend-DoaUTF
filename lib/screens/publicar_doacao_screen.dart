...
class PublicarDoacaoScreen extends StatefulWidget {
  const PublicarDoacaoScreen({super.key});

  @override
  State<PublicarDoacaoScreen> createState() => _PublicarDoacaoScreenState();
}

class _PublicarDoacaoScreenState extends State<PublicarDoacaoScreen> {
  int  _step      = 0;
...
} // ← fim de _PublicarDoacaoScreenState
